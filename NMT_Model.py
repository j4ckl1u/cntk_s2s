...
class GRU_NMT_Model:
    ...
    def __init__(self):
        self.EmbSrc = C.layers.Embedding(Config.EmbeddingSize, init=C.glorot_uniform())
        self.EmbTrg = C.layers.Embedding(Config.EmbeddingSize, init=C.glorot_uniform())
        ...
        self.Wt = C.parameter(shape=(Config.TrgHiddenSize, Config.TrgVocabSize), init=C.glorot_uniform())
        self.Wtb = C.parameter(shape=(Config.TrgVocabSize), init=C.glorot_uniform())
        self.WI = C.parameter(shape=(Config.SrcHiddenSize, Config.TrgHiddenSize), init=C.glorot_uniform())
        self.WIb = C.parameter(shape=(Config.TrgHiddenSize), init=C.glorot_uniform())
        self.Was = C.parameter(shape=(Config.SrcHiddenSize*2, Config.TrgHiddenSize), init=C.glorot_uniform())
        self.Wat = C.parameter(shape=(Config.TrgHiddenSize, Config.TrgHiddenSize), init=C.glorot_uniform())
        self.Wav = C.parameter(shape=(Config.TrgHiddenSize, 1), init=C.glorot_uniform())
